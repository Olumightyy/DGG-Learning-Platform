...
function YouTubePlayer({ url, title, className = "" }) {
    ...
    const videoId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$youtube$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractYouTubeId"])(url);
    if (!videoId) {
...
_s(YouTubePlayer, "5S7VQ8+9ArWv2AFPIfnY+LwrHeg=");
_c = YouTubePlayer;
var _c;
...
//# sourceMappingURL=_697e9130._.js.map