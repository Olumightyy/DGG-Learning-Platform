...
export default async function StudentLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Mobile top bar */}
      <nav className="sticky top-0 z-20 w-full border-b border-[#512d7c]/15 bg-white/80 backdrop-blur lg:hidden">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
          <Link href="/student/dashboard" className="text-lg font-bold text-[#512d7c]">
            DGG Learning
          </Link>
          ...
          <details className="relative">
            ...
            <div className="absolute right-0 mt-2 w-64 rounded-md border border-gray-200 bg-white p-2 shadow-lg">
              <div className="flex flex-col">
                <Link href="/student/dashboard" className="rounded px-3 py-2 text-sm hover:bg-gray-100">
                  Dashboard
                </Link>
                <Link href="/student/explore" className="rounded px-3 py-2 text-sm hover:bg-gray-100">
                  Explore Courses
                </Link>
                <a
        ...
        <aside className="sticky top-0 hidden h-[100svh] border-r border-[#512d7c]/15 bg-white lg:block">
          <div className="flex h-full flex-col">
            <div className="px-5 py-4">
              <Link href="/student/dashboard" className="block text-xl font-bold text-[#512d7c]">
                DGG Learning
              </Link>
              <p className="mt-1 text-xs text-gray-500">Student</p>
            </div>
